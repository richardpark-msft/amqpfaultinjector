...
func (e *EmptyFrame) frameBody()         {}
func (e *EmptyFrame) Type() BodyType     { return BodyTypeEmptyFrame }
func (e *EmptyFrame) GetHandle() *uint32 { return nil }
...
func (o *PerformOpen) Type() BodyType     { return BodyTypeOpen }
func (o *PerformOpen) GetHandle() *uint32 { return nil }
...
func (b *PerformBegin) Type() BodyType     { return BodyTypeBegin }
func (b *PerformBegin) GetHandle() *uint32 { return nil }
...
func (a *PerformAttach) Type() BodyType     { return BodyTypeAttach }
func (a *PerformAttach) GetHandle() *uint32 { return &a.Handle }
...
func (f *PerformFlow) Type() BodyType     { return BodyTypeFlow }
func (f *PerformFlow) GetHandle() *uint32 { return f.Handle }
...
func (t *PerformTransfer) Type() BodyType     { return BodyTypeTransfer }
func (t *PerformTransfer) GetHandle() *uint32 { return &t.Handle }
...
func (d *PerformDisposition) Type() BodyType     { return BodyTypeDisposition }
func (d *PerformDisposition) GetHandle() *uint32 { return nil }
...
func (d *PerformDetach) Type() BodyType     { return BodyTypeDetach }
func (d *PerformDetach) GetHandle() *uint32 { return &d.Handle }
...
func (e *PerformEnd) Type() BodyType     { return BodyTypeEnd }
func (e *PerformEnd) GetHandle() *uint32 { return nil }
...
func (c *PerformClose) Type() BodyType     { return BodyTypeClose }
func (c *PerformClose) GetHandle() *uint32 { return nil }
...
func (si *SASLInit) Type() BodyType     { return BodyTypeSASLInit }
func (si *SASLInit) GetHandle() *uint32 { return nil }
...
func (sm *SASLMechanisms) Type() BodyType     { return BodyTypeSASLMechanisms }
func (sm *SASLMechanisms) GetHandle() *uint32 { return nil }
...
func (sc *SASLChallenge) Type() BodyType     { return BodyTypeSASLChallenge }
func (sc *SASLChallenge) GetHandle() *uint32 { return nil }
...
func (sr *SASLResponse) Type() BodyType     { return BodyTypeSASLResponse }
func (sr *SASLResponse) GetHandle() *uint32 { return nil }
...
func (so *SASLOutcome) Type() BodyType     { return BodyTypeSASLOutcome }
func (so *SASLOutcome) GetHandle() *uint32 { return nil }
